...
class ComponenteSchema(BaseModel):
    ...
    estado_conservacao: str = Field(..., description="Estado de conservação do item")
...
estoque_laboratorio = [
    ...
    {"id": 2, "nome": "Micro Servo Motor SG90", "quantidade": 42, "categoria": "Atuadores", "estado_conservacao": "Usado"},
    {"id": 3, "nome": "Esteira em Acrílico", "quantidade": 2, "categoria": "Mecânica", "estado_conservacao": "Seminovo"}
]
